...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\ApiKeyUserProvider A AppBundle\Security\ApiKeyUserProvider instance.
     */
    protected function getApiKeyUserProviderService()
    {
        return $this->services['api_key_user_provider'] = new \AppBundle\Security\ApiKeyUserProvider();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 8889, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_925e3762c4e4510df91152f04aa207565f410ae7294441eddc712599f5193cda');
    ...
    protected function getSecurity_FirewallService()
    {
        ...
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.default' => $a, 'security.firewall.map.context.secured_area' => $a, 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'))), $this->get('debug.event_dispatcher'));
    }
     ...
     *
     * @return \AppBundle\Security\ApiKeyAuthenticator A AppBundle\Security\ApiKeyAuthenticator instance.
     */
    protected function getApikeyAuthenticatorService()
    {
        return $this->services['apikey_authenticator'] = new \AppBundle\Security\ApiKeyAuthenticator();
    }
